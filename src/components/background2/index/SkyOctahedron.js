...
import skyOctahedronVS from './glsl/skyOctahedron.vs';
import skyOctahedronFS from './glsl/skyOctahedron.fs';
  ...
  createObj() {
    ...
    return new THREE.Mesh(
      ...
      new THREE.RawShaderMaterial({
        ...
        fragmentShader: skyOctahedronFS,
        vertexShader: skyOctahedronVS,
        transparent: true,
