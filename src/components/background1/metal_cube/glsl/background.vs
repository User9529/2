...
float customInverseFloat(float m) {
  return 1.0 / m;
}

mat2 customInverseMat2(mat2 m) {
  return mat2(m[1][1], -m[0][1],
      -m[1][0], m[0][0]) / (m[0][0] * m[1][1] - m[0][1] * m[1][0]);
}

mat3 customInverseMat3(mat3 m) {
...
void main() {
  ...
  invertMatrix = customInverseMat4(modelMatrix); // 使用改名后的函数
